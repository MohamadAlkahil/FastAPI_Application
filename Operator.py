...
def getMap():
    response = requests.get("https://coe892lab42022g500897490.azurewebsites.net//map").json()
...
def putMap(x, y):
    upmap ={"xdim": x, "ydim": y}
    response = requests.put("https://coe892lab42022g500897490.azurewebsites.net/map/",json=upmap).json()
    print(response)

def getMines():
    response = requests.get("https://coe892lab42022g500897490.azurewebsites.net/mines").json()
    print(response)

def getMinesid(id):
    response = requests.get("https://coe892lab42022g500897490.azurewebsites.net/mines/"+str(id)).json()
    print(response)

def deleteMine(id):
    response = requests.delete("https://coe892lab42022g500897490.azurewebsites.net/mines/" + str(id)).json()
    print(response)

def postMine(x, y, serial_num):
    mine ={"x": x, "y": y, "serial_num": serial_num}
    response = requests.post("https://coe892lab42022g500897490.azurewebsites.net/mines/",json=mine).json()
    print(response)

def putMine(id, x, y, serial_num):
    mine ={"x": x, "y": y, "serial_num": serial_num}
    response = requests.put("https://coe892lab42022g500897490.azurewebsites.net/mines/"+ str(id) + "/",json=mine).json()
    print(response)

def getrovers():
    response = requests.get("https://coe892lab42022g500897490.azurewebsites.net/rovers").json()
    print(response)

def getroversid(id):
    response = requests.get("https://coe892lab42022g500897490.azurewebsites.net/rovers/"+str(id)).json()
    print(response)

def postRover(moves):
    rover ={"roverStatus": "Not Started","x": 0, "y": 0, "moves": moves}
    response = requests.post("https://coe892lab42022g500897490.azurewebsites.net/rovers/",json=rover).json()
    print(response)

def deleterover(id):
    response = requests.delete("https://coe892lab42022g500897490.azurewebsites.net/rovers/" + str(id)).json()
    print(response)

def putRover(id, roverStatus, x, y, moves):
    rover = {"roverStatus": roverStatus, "x": x, "y": y, "moves": moves}
    response = requests.put("https://coe892lab42022g500897490.azurewebsites.net/rovers/" + str(id) + "/", json=rover).json()
    print(response)

def dispatchRover(id):
    response = requests.post("https://coe892lab42022g500897490.azurewebsites.net/rovers/"+ str(id) + "/dispatch").json()
    print(response)
